...
if os.path.basename(backend_dir) == 'scratch':
...
output_sql_path = os.path.join(os.path.dirname(backend_dir), 'docs', 'dumps', 'sample_data_listings.sql')
...
print(f"Target Output: {output_sql_path}")
print("=============================================================\n")
...
try:
    with engine.connect() as conn:
        ...
        print(f"Sample data written to: {output_sql_path}")
